; ModuleID = '/home/ambikas2/cs526/bench_results/bc/offset.bc'
source_filename = "/home/ambikas2/cs526/kernels/offset.cl"
...
entry:
  ...
  %add1.i = add nsw i32 %6, 8
  %idxprom2.i = sext i32 %add1.i to i64
  %arrayidx3.i = getelementptr inbounds float, ptr addrspace(1) %5, i64 %idxprom2.i
  store float %4, ptr addrspace(1) %arrayidx3.i, align 4
  ret void
}
...
entry:
  ...
  %add1 = add nsw i32 %4, 8
  %idxprom2 = sext i32 %add1 to i64
  %arrayidx3 = getelementptr inbounds float, ptr addrspace(1) %3, i64 %idxprom2
  store float %2, ptr addrspace(1) %arrayidx3, align 4
  ret void
}
